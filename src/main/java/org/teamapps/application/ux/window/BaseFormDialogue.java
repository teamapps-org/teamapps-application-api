...
public class BaseFormDialogue extends Window {
	...
	public static BaseFormDialogue create(Icon icon, String title, String text) {
		return new BaseFormDialogue(icon, title, text);
	}

	public BaseFormDialogue(Icon icon, String title, String text) {
		this(icon, null, title, text);
	}

	public BaseFormDialogue(Icon icon, String imageUrl, String title, String text) {
		this(icon, imageUrl, title, text, ResponsiveFormConfigurationTemplate.createDefaultTwoColumnTemplate(0, 200, 0));
	}

	public BaseFormDialogue(Icon icon, String imageUrl, String title, String text, ResponsiveFormConfigurationTemplate configurationTemplate) {
		setIcon(icon);
		setTitle(title);
		setWidth(550);
		setHeight(350);
	...
	public Button<?> addOkButton(String caption) {
		return addOkButton(ApplicationIcons.OK, caption);
	}
	...
	public Button<?> addCancelButton(String caption) {
		return addCancelButton(ApplicationIcons.WINDOW_CLOSE, caption);
	}
