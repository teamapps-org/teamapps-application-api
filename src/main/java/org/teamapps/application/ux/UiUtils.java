...
public class UiUtils {
	...
	public static TemplateField<String> createBadgeField(Color textColor, Color backgroundColor, String value) {
		TemplateField<String> badgeField = createBadgeField(textColor, backgroundColor);
		badgeField.setValue(value);
		return badgeField;
	}
